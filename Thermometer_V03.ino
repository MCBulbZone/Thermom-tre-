...
/***************************************************************************************
Code exemple pour le thermometre imprimable.

Ce code permet d'allumer avec des intervalles définis (permet d'economiser la batterie)
les leds afin d'indiquer la temperature ambiante avec une precision de 5 degres.

cette precision est du au nombre de led sur la face avant,mais rien ne vous
empeche de creer des effets lumineux afin d'augmenter la précision.

Vous pouvez definir une temperature de seuil minimum et maximum grace aux variables
"tempMin" et "tempMax", cela activera un effet lumineux vous avertissant que le seuil est
depasse.

une fonction bonus permet de faire un chenillard avec les leds afin de vous prevenir
qu'il est temps de vous levez de votre chaise pour prendre un cafe, marcher un peu ou
tout simplement eviter les courbatures dans le dos.

Les leds sont connectees a la PIN 3 du Pro Trinket et le capteur a la PIN 4.

//code ecrit par Mickael Captant
//Bulb Zone - 2015
***************************************************************************************/
...
long interval = 1200;           // temps entre chaque coupure et la duree total d'allumage
long interval2 =18000;           // bonus "STAND UP"
